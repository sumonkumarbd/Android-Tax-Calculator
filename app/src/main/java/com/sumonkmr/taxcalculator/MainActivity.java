...
//                variabls with Theory
                ...
                //                ResultBar
                amountResult.setText(userValue + টাকা);


//                firstMathod
                    if (newUserInput <= a1) {
                        c1.setText(userValue + টাকা);
                        d1.setText("0 টাকা");
                        c2.setText("");
                        d2.setText("");
                        taxResult.setText("0 টাকা");
                        //                TextToSpeech
...
//            firstMathod
                    ...
                    if (newUserInput > a1 && newUserInput <= a2) {
                        c2.setText(ftaxAmount + টাকা);
                        d2.setText(fstTax + " টাকা");
                        taxResult.setText(fstTax+টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
                        int taxResult = sp.speak(fstTax,TextToSpeech.QUEUE_ADD,null);
                        int tk = sp.speak("টাকা",TextToSpeech.QUEUE_ADD,null);
                        ...
                        c2.setText(sMaxsecAmount + টাকা);
                        d2.setText(sMaxsecTax + টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
...
//                THirdMathod
                    if (newUserInput > a2 && newUserInput <= a3) {
                        c3.setText(secTaxAmount + টাকা);
                        d3.setText(secTax + টাকা);
                        double sumSecTax =secondTax + 5000;
                        String newSumSecTax = String.format("%,.2f",sumSecTax);
                        taxResult.setText(newSumSecTax+টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
                        ...
                        c3.setText(sThirdMaxAmount + টাকা);
                        d3.setText(sthirdMaxTax + টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
...
//                fouthMathod
                    if (newUserInput > a3 && newUserInput <= a4) {
                        c4.setText(thirdTaxAmount + টাকা);
                        d4.setText(sThirdTax + টাকা);
                        double sumThirdTax = thirdTax + 35000;
                        String newSumThirdTax = String.format("%,.2f",sumThirdTax);
                        taxResult.setText(newSumThirdTax+টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
                        ...
                        c4.setText(sfourthMaxAmount + টাকা);
                        d4.setText(sfourthMaxTax + টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
...
//                FifthMathod
                    if (newUserInput > a4 && newUserInput <= a5) {
                        c5.setText(fourthTaxAmount + টাকা);
                        d5.setText(newfourthTax + টাকা);
                        double sumfourthTax = fourthTax + 95000;
                        String newFourthTax = String.format("%,.2f",sumfourthTax);
                        taxResult.setText(newFourthTax+টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
                      ...
                      String sfifthMaxAmount = String.format("%,.2f",fifthMaxAmount);
                        ...
                        c5.setText(sfifthMaxAmount + টাকা);
                        d5.setText(sfifthMaxTax + টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
...
//                SixthMethod
                    if (newUserInput > a5) {
                        c6.setText(fifthTaxAmount + টাকা);
                        d6.setText(newfifthTax + টাকা);
                        double sumFifthTax = fifthTax + 195000;
                        String newSumFifthTax = String.format("%,.2f",sumFifthTax);
                        taxResult.setText(newSumFifthTax+টাকা);
                        //                TextToSpeech
                        int speech = sp.speak("আপনার ট্যাক্স হচ্ছে",TextToSpeech.QUEUE_FLUSH,null);
